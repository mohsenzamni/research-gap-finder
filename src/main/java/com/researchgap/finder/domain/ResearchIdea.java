...
public class ResearchIdea {
 ...
 public ResearchIdea(Project project, ResearchGap gap, String title, String proposal,
                     double score, String evidenceStrength, String provenance) {
